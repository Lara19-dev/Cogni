...
client.on("message", message => {
  ...
  if(msg.startsWith("<:lemons:322459208731721738>") || msg.startsWith("<:lemons:613083652620025907>") || msg.startsWith("lemon")){
    message.channel.send(emoji("613083652620025907"));
  };
  if(msg == "fite me"){
